...
-   类A为基类，类B是类A的派生类，类C是类B的派生类，则类C也是类A的派生类。类B称为类A的直接派生类，类C称为类A的间接派生类。类A是类B的直接基类，是类C的间接基类。
    ...
    ![image-20200524090254651](https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524090254651.png)
...
-   如果类A和类B中都有成员函数display和数据成员a，类C是类A和类B的直接派生类。
    ...
    -   两个基类有同名成员
        ...
        <img src="https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524132603183.png" alt="image-20200524132603183" style="zoom:80%;" />
        ...
        ![image-20200524132803131](https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524132803131.png)
    ...
    -   两个基类和派生类三者有同名成员
        ...
        <img src="https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524133121919.png" alt="image-20200524133121919" style="zoom:80%;" />
        ...
        规则是: 基类的同名成员在派生类中被屏蔽，成为“不可见”的，或者说，派生类新增加的同名成员覆盖了基类中的同名成员。因此如果在定义派生类对象的模块中通过对象名访问同名的成员，则访问的是派生类的成员。不同的成员函数，只有在函数名和参数个数相同、类型相匹配的情况下才发生同名覆盖，如果只有函数名相同而参数不同，不会发生同名覆盖，而属于函数重载。
    ...
    -   类A和类B是从同一个基类派生的
        ...
        <img src="https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524133336403.png" alt="image-20200524133336403" style="zoom:80%;" />
        ...
        <img src="https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524133719440.png" alt="image-20200524133719440" style="zoom:80%;" />
        
        <img src="https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524133748439.png" alt="image-20200524133748439" style="zoom:80%;" />
        ...
        ```C++
        c1.A::a=3; c1.A::display();//要访问的是类N的派生类A中的基
        ```
...
-   C++提供虚基类的方法，使得在继承间接共同基类时只保留一份成员。
    ...
    <img src="https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524154019675.png" alt="image-20200524154019675" style="zoom:80%;" />

    <img src="https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524154042173.png" alt="image-20200524154042173" style="zoom:80%;" />
...
-   在派生类B和C中作了上面的虚基类声明后，派生类D中的成员如图所示。
    ...
    <img src="https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524154409101.png" alt="image-20200524154409101" style="zoom:80%;" />

    | D类                                           |
    | :-------------------------------------------- |
    | int  data;<br>int  data_b; <br>int  data_c  ; |
    | void  fun( );                                 |
    | int  data_d;                                  |
    | void  fun_d( );                               |
...
-   需要注意: 为了保证虚基类在派生类中只继承一次，应当在该基类的所有直接派生类中声明为虚基类。否则仍然会出现对基类的多次继承。
    ...
    ![image-20200524154652648](https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524154652648.png)
...
-   基类与派生类对象之间有赋值兼容关系，由于派生类中包含从基类继承的成员，因此可以**将派生类**的值赋给基类对象，在用到基类对象的时候可以用其子类对象代替。
...
-   所谓赋值只是对数据成员赋值，对成员函数不存在赋值问题。
    ...
    ![image-20200524155427985](https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524155427985.png) 
...
-   如已定义了基类A对象a1，可以定义a1的引用变量:
    ...
    ![image-20200524155918257](https://raw.githubusercontent.com/LvFinch/ImgHost/master/Images/image-20200524155918257.png)
...
-   如有一函数fun: 
    ...
    ```
       ...
       输出类B的对象b1的基类数据成员num的值。在fun函数中只能输出派生类中基类成员的值。
...
-   例6.4
-   一个基类如果包含一个或一个以上纯虚函数，就是抽象基类。抽象基类不**能也不必要**定义对象。
